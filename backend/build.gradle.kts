...
sonar {
    properties {
        ...
        // ↓ Exclude duplication warning caused by LDML-Transformer, ObjectValueDTO.java, Rechtszug.java, AttachmentDTO.java
        property("sonar.cpd.exclusions", "**/DecisionCommonLdmlTransformer.java, **/PendingProceedingCommonLdmlTransformer.java, **/AbuseFeeDTO.java, **/AnhaengigesVerfahren.java, **/Rechtszug.java, **/AttachmentInlineDTO.java")
...
dependencies {
    ...
    implementation("de.bund.digitalservice:neuris-juris-xml-export:0.10.50") {
    ...
    implementation("de.bund.digitalservice:neuris-caselaw-migration-schema:0.0.138")
    // for local development:
    // implementation(files("../../ris-data-migration/schema/build/libs/schema-0.0.138.jar"))
    ...
    annotationProcessor("org.hibernate:hibernate-jpamodelgen:7.2.5.Final")
