...
//     implementation(files("../../neuris-juris-xml-export/build/libs/neuris-juris-xml-export-0.10.32.jar"))
    ...
    implementation("de.bund.digitalservice:neuris-caselaw-migration-schema:0.0.57")
    // for local development:
    // implementation(files("../../ris-data-migration/schema/build/libs/schema-0.0.56.jar"))
