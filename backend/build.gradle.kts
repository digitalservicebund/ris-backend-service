...
dependencies {
    ...
    implementation("de.bund.digitalservice:neuris-caselaw-migration-schema:0.0.50")
    // for local development:
    // implementation(files("../../ris-data-migration/schema/build/libs/schema-0.0.50.jar"))
