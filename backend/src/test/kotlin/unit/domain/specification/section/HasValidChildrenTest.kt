...
class HasValidChildrenTest {
  ...
  fun `it is satisfied that the official reference section only contains only one of the allowed children sections`() {
    ...
    every { instance.sections } returns
        listOf(
            MetadataSection(
    ...
    every { instance.sections } returns
        listOf(
            ...
            MetadataSection(
                ...
                listOf(Metadatum("text", MetadatumType.TEXT))),
            MetadataSection(
  ...
  fun `it is satisfied that the status indication section only contains only one of the allowed children sections`() {
    ...
    every { instance.sections } returns
        listOf(
            MetadataSection(
                MetadataSectionName.STATUS, listOf(Metadatum("note", MetadatumType.NOTE))),
            MetadataSection(
                MetadataSectionName.REISSUE, listOf(Metadatum("article", MetadatumType.ARTICLE))),
            MetadataSection(
                MetadataSectionName.REPEAL, listOf(Metadatum("text", MetadatumType.TEXT))),
            MetadataSection(
