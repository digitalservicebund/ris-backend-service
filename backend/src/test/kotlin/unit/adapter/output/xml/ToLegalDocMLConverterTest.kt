...
class ToLegalDocMLConverterTest {
  ...
  fun `it creates the identification tag with proper data`() {
        ...
        MetadataSection(
            ...
            listOf(
                MetadataSection(
                    ...
                    listOf(
                        Metadatum(
                            "printAnnouncementGazette", MetadatumType.ANNOUNCEMENT_GAZETTE, 1),
    ...
    // Assert Work
    assertThat(workThis.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102/regelungstext-1")
    assertThat(workUri.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102")
    ...
    assertThat(workAuthor.attributes.getNamedItem("href").nodeValue)
        .isEqualTo("recht.bund.de/institution/bundesregierung")
    ...
    assertThat(workName.attributes.getNamedItem("value").nodeValue)
    ...
    // AssertManifestation
    assertThat(manifestationThis.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102/2001-01-01/1/deu/regelungstext-1.xml")
    assertThat(manifestationUri.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102/2001-01-01/1/deu/regelungstext-1.xml")
    assertThat(manifestationDate.attributes.getNamedItem("date").nodeValue).isEqualTo("2001-01-01")
    assertThat(manifestationAuthor.attributes.getNamedItem("href").nodeValue)
        .isEqualTo("recht.bund.de")
    // AssertExpression
    assertThat(expressionThis.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102/2001-01-01/1/deu/regelungstext-1")
    assertThat(expressionUri.attributes.getNamedItem("value").nodeValue)
        .isEqualTo("eli/printAnnouncementGazette/2001/s1102/2001-01-01/1/deu")
    assertThat(expressionDate.attributes.getNamedItem("date").nodeValue).isEqualTo("2001-01-01")
    assertThat(expressionAuthor.attributes.getNamedItem("href").nodeValue)
        .isEqualTo("recht.bund.de/institution/bundesregierung")
  }
                    ...
                    metadataSections =
                        listOf(
                            ...
                            MetadataSection(
                                ...
                                listOf(
                                    Metadatum(LocalDate.parse("2002-02-02"), MetadatumType.DATE))),
                            MetadataSection(
                                MetadataSectionName.NORM_PROVIDER,
                                listOf(
                                    Metadatum(
                                        "providerDecidingBody", MetadatumType.DECIDING_BODY))),
                            MetadataSection(
                            ...
                            MetadataSection(
                                ...
                                listOf(
                                    Metadatum(
                                        ...
                                        MetadatumType.DECIDING_BODY))),
                            MetadataSection(
                                MetadataSectionName.DOCUMENT_TYPE,
                                listOf(
                                    Metadatum("SO", MetadatumType.TYPE_NAME),
                                    Metadatum(
                                        NormCategory.AMENDMENT_NORM, MetadatumType.NORM_CATEGORY),
                                ),
                            ),
                        ),
                ),
                    ...
                    metadataSections =
                        listOf(
                            MetadataSection(
                                ...
                                listOf(
                                    Metadatum(
                                        "BMinisterium", MetadatumType.PARTICIPATION_INSTITUTION))),
                            MetadataSection(
                                MetadataSectionName.CITATION_DATE,
                                listOf(
                                    Metadatum(LocalDate.parse("2002-02-02"), MetadatumType.DATE))),
                            MetadataSection(
                                MetadataSectionName.NORM_PROVIDER,
                                listOf(
                                    Metadatum("Bundesministerinnen", MetadatumType.DECIDING_BODY))),
                        ),
                ),
        )
  ...
  @Test
  fun `it creates an article element with its paragraph and content`() {
    val paragraph =
        Paragraph(guid = UUID.randomUUID(), marker = "§ 1.1", text = "test paragraph text")
    val article =
        Article(
    ...
    assertThat(articleNumber.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_bezeichnung-1")
    ...
    assertThat(articleHeading.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_überschrift-1")
    assertThat(articleHeading.textContent.trim()).isEqualTo("test article title")
    assertThat(paragraphElement.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_abs-1.1")
    assertThat(paragraphNumber.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_abs-1.1_bezeichnung-1")
    ...
    assertThat(paragraphContent.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_abs-1.1_inhalt-1")
    assertThat(paragraphContentP.attributes.getNamedItem("eId").nodeValue)
        .isEqualTo("para-9a_abs-1.1_inhalt-1_text-1")
  ...
  @Test
  fun `it creates an article element with its paragraph and content containing a nested list`() {
    val paragraph =
        Paragraph(
            guid = UUID.randomUUID(),
            marker = "(1)",
    ...
    val firstPoint2ndLevelContent =
        getFirstChildNodeWithTagName(firstPointListPoints[0], "akn:content")
    val firstPoint2ndLevelContentP =
        getFirstChildNodeWithTagName(firstPoint2ndLevelContent, "akn:p")
    val secondPoint2ndLevelNum = getFirstChildNodeWithTagName(firstPointListPoints[1], "akn:num")
    val secondPoint2ndLevelMarker =
        getFirstChildNodeWithTagName(secondPoint2ndLevelNum, "akn:marker")
    ...
    val secondPoint2ndLevelListIntro =
        getFirstChildNodeWithTagName(secondPoint2ndLevelList, "akn:intro")
    val secondPoint2ndLevelListIntroP =
        getFirstChildNodeWithTagName(secondPoint2ndLevelListIntro, "akn:p")
    val secondPoint2ndLevelPoints = getChildrenWithTagName(secondPoint2ndLevelList, "akn:point")
    val firstPoint3ndLevelNum =
        getFirstChildNodeWithTagName(secondPoint2ndLevelPoints[0], "akn:num")
    val firstPoint3ndLevelMarker = getFirstChildNodeWithTagName(firstPoint3ndLevelNum, "akn:marker")
    val firstPoint3ndLevelContent =
        getFirstChildNodeWithTagName(secondPoint2ndLevelPoints[0], "akn:content")
    val firstPoint3ndLevelContentP =
        getFirstChildNodeWithTagName(firstPoint3ndLevelContent, "akn:p")
    val secondPoint3ndLevelNum =
        getFirstChildNodeWithTagName(secondPoint2ndLevelPoints[1], "akn:num")
    val secondPoint3ndLevelMarker =
        getFirstChildNodeWithTagName(secondPoint3ndLevelNum, "akn:marker")
    val secondPoint3ndLevelContent =
        getFirstChildNodeWithTagName(secondPoint2ndLevelPoints[1], "akn:content")
    val secondPoint3ndLevelContentP =
        getFirstChildNodeWithTagName(secondPoint3ndLevelContent, "akn:p")
  ...
  fun `it produces valid xml content according to xml schema definition`() {
    ...
    val schema =
        schemaFactory.newSchema(
            File(
                "src/main/resources/legaldocml/schemas/legalDocML.de-regelungstextentwurfsfassung.xsd"))
