...
class ToJurisMapperTest {
  ...
  fun `it correctly maps the domain to data`() {
                    ...
                    listOf(
                        Section(
                            ...
                            listOf(
                                ...
                                Metadatum(
                                    "Bedingungseintritt für bedingte Inkraftsetzung",
                                ...
                                Metadatum(
                                    "maßgebliches Einkommen (Abs 1)",
                                    MetadatumType.DEFINITION,
                                    order = 2),
                                Metadatum(
                                    "1 BvR 2011/94", MetadatumType.REFERENCE_NUMBER, order = 1),
                                Metadatum(
                                    "19 BvR 2019/23", MetadatumType.REFERENCE_NUMBER, order = 2),
                                Metadatum(
                                    "BGBl I 2009, 1102",
                                ...
                                Metadatum(
                                    ...
                                    order = 2),
                                Metadatum(
                                    "Gebührenordnung für tierärztliche Leistungen",
                                    MetadatumType.UNOFFICIAL_LONG_TITLE,
                                    order = 1),
                                Metadatum(
                                    "Das Geld für die Tiere",
                                    MetadatumType.UNOFFICIAL_LONG_TITLE,
                                    order = 2),
                                Metadatum(
                                    "Tiergeld", MetadatumType.UNOFFICIAL_SHORT_TITLE, order = 1),
                                Metadatum(
                                    "Animal money",
                        ...
                        Section(
                            ...
                            listOf(Metadatum("2002", MetadatumType.YEAR)),
                            1),
                        Section(
                            MetadataSectionName.CITATION_DATE,
                            listOf(Metadatum(LocalDate.parse("2019-10-01"), MetadatumType.DATE)),
                            2),
                        Section(
                                ...
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            ...
                                            Metadatum(
                                                "Additional info 1", MetadatumType.ADDITIONAL_INFO),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "BGBl III", MetadatumType.ANNOUNCEMENT_MEDIUM),
                                            Metadatum(
                                                LocalDate.parse("2011-12-03"), MetadatumType.DATE),
                                            Metadatum("2011", MetadatumType.YEAR),
                                            Metadatum("16", MetadatumType.EDITION),
                                            Metadatum("52", MetadatumType.PAGE),
                                            Metadatum(
                                                "Area of publication 3",
                                                MetadatumType.AREA_OF_PUBLICATION),
                                            Metadatum(
                                                "Number of the publication 3",
                                                MetadatumType
                                                    .NUMBER_OF_THE_PUBLICATION_IN_THE_RESPECTIVE_AREA),
                                            Metadatum(
                                                "Additional info 3", MetadatumType.ADDITIONAL_INFO),
                                ...
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            ...
                                            Metadatum(
                                                LocalDate.parse("2015-06-23"), MetadatumType.DATE),
                                            Metadatum("2015", MetadatumType.YEAR),
                                            Metadatum("65", MetadatumType.EDITION),
                                            Metadatum("89", MetadatumType.PAGE),
                                            Metadatum(
                                                "Area of publication 4",
                                                MetadatumType.AREA_OF_PUBLICATION),
                                            Metadatum(
                                                "Number of the publication 4",
                                                MetadatumType
                                                    .NUMBER_OF_THE_PUBLICATION_IN_THE_RESPECTIVE_AREA),
                                            Metadatum(
                                                "Additional info 4", MetadatumType.ADDITIONAL_INFO),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "BGBl I", MetadatumType.EU_GOVERNMENT_GAZETTE),
                                            Metadatum("2021", MetadatumType.YEAR),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "BGBl II", MetadatumType.EU_GOVERNMENT_GAZETTE),
                                            Metadatum("2019", MetadatumType.YEAR),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "Other official reference 1",
                                                MetadatumType.OTHER_OFFICIAL_REFERENCE))),
                                ),
                        ),
                        Section(
                            MetadataSectionName.OFFICIAL_REFERENCE,
                        ...
                        Section(
                            ...
                            listOf(
                                ...
                                Metadatum(
                                    NormCategory.BASE_NORM, MetadatumType.NORM_CATEGORY, order = 1),
                                Metadatum(
                        ...
                        Section(
                            ...
                            listOf(
                                Metadatum(
                                    "&A 31 &B Art 1 Nr 4 Buchst a &E HGB &E3 § 246 &E6 Abs 1",
                                    MetadatumType.TEXT),
                            ),
                            1,
                        ),
                        ...
                        Section(
                            ...
                            listOf(
                                Metadatum(
                                    UndefinedDate.UNDEFINED_UNKNOWN, MetadatumType.UNDEFINED_DATE),
                            ),
                        ),
                        Section(
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                LocalDate.parse("2014-11-11"), MetadatumType.DATE),
                                            Metadatum(
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                LocalDate.parse("2010-06-15"), MetadatumType.DATE),
                                            Metadatum(
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                LocalDate.parse("2011-11-09"), MetadatumType.DATE),
                                            Metadatum(
                                                NormCategory.TRANSITIONAL_NORM,
                                                MetadatumType.NORM_CATEGORY),
                                        ),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                LocalDate.parse("2008-05-29"), MetadatumType.DATE),
                                            Metadatum(
                                                NormCategory.BASE_NORM,
                                                MetadatumType.NORM_CATEGORY),
                                        ),
                                ...
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            ...
                                            Metadatum(
                                                "statusDescription", MetadatumType.DESCRIPTION),
                                            Metadatum(
                                                LocalDate.parse("2010-01-01"), MetadatumType.DATE),
                                            Metadatum(
                                                "statusReference1", MetadatumType.REFERENCE, 1),
                                            Metadatum(
                                                "statusReference2", MetadatumType.REFERENCE, 2),
                                        ),
                                    ),
                                ),
                        ),
                                ...
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            ...
                                            Metadatum(
                                                LocalDate.parse("2012-02-02"), MetadatumType.DATE),
                        ...
                        Section(
                            ...
                            listOf(
                                Metadatum(
                                    "reference1", MetadatumType.FOOTNOTE_REFERENCE, order = 1),
                                Metadatum(
                                    "footnoteChangeA", MetadatumType.FOOTNOTE_CHANGE, order = 2),
                                Metadatum(
                                    "footnoteComment1", MetadatumType.FOOTNOTE_COMMENT, order = 3),
                                Metadatum(
                                    "footnoteChangeB", MetadatumType.FOOTNOTE_CHANGE, order = 4),
                                Metadatum(
                                    "footnoteDecision1",
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "Textnachweis ab: 26.10.2001", MetadatumType.TEXT),
                                        ),
                                    ),
                                ),
                        ),
                            ...
                            sections =
                                listOf(
                                    Section(
                                        ...
                                        listOf(
                                            Metadatum(
                                                "documentStatusNote1", MetadatumType.WORK_NOTE),
                                            Metadatum(
                                                "documentStatusNote2", MetadatumType.WORK_NOTE),
                                            Metadatum(
                                                "documentStatusDescription",
                                                MetadatumType.DESCRIPTION),
                                            Metadatum(
                                                LocalDate.parse("2010-03-04"), MetadatumType.DATE),
                                            Metadatum(
                                                "documentStatusReference", MetadatumType.REFERENCE),
                                        ),
                                    ),
                                ),
                        ),
    ...
    assertThat(normData.validityRuleList[1])
        .isEqualTo("Bedingungseintritt für bedingte Inkraftsetzung")
    ...
    assertThat(normData.unofficialLongTitleList[0])
        .isEqualTo("Gebührenordnung für tierärztliche Leistungen")
    ...
    assertThat(normData.categorizedReferences[0].text)
        .isEqualTo("&A 31 &B Art 1 Nr 4 Buchst a &E HGB &E3 § 246 &E6 Abs 1")
    assertThat(normData.categorizedReferences[1].text)
        .isEqualTo("&A 32 &B Art 1 Nr 4 Buchst b &E HGB &E3 § 246 &E6 Abs 2 S 2 und 3")
    ...
    assertThat(normData.statusList[0].statusDate).isEqualTo("1.1.2010")
    assertThat(normData.statusList[0].statusReference)
        .isEqualTo("statusReference1, statusReference2")
    ...
    assertThat(normData.reissueList[0].reissueDate).isEqualTo("2.2.2012")
    assertThat(normData.reissueList[0].reissueReference).isEqualTo("reissueReference")
    assertThat(normData.repealList).hasSize(2)
    assertThat(normData.repealList.containsAll(listOf("repealReference1", "repealReference2")))
        .isTrue()
    ...
    assertThat(normData.documentStatus[0].documentStatusWorkNote[0])
        .isEqualTo("documentStatusNote1")
    assertThat(normData.documentStatus[0].documentStatusWorkNote[1])
        .isEqualTo("documentStatusNote2")
    assertThat(normData.documentStatus[0].documentStatusDescription)
        .isEqualTo("documentStatusDescription")
    assertThat(normData.documentStatus[0].documentStatusDateYear).isEqualTo("2010-03-04")
    assertThat(normData.documentStatus[0].documentStatusReference)
        .isEqualTo("documentStatusReference")
