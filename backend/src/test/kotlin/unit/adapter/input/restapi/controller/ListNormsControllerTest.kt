...
class ListNormsControllerTest {
  ...
  fun `it maps the norm entity to the expected data schema`() {
    ...
    val normOne =
        NormData(UUID.fromString("761b5537-5aa5-4901-81f7-fbf7e040a7c8"), "first title", eliOne)
    val normTwo =
        NormData(UUID.fromString("53d29ef7-377c-4d14-864b-eb3a85769359"), "second title", eliTwo)
