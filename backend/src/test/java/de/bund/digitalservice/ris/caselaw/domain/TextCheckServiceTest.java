...
class TextCheckServiceTest {
  ...
  //            List.of("word"),
  //            "<p>\"[<noindex>word</noindex>]\" - words in square brackets should be
  // replaced</p>"),
  //        Arguments.of(
  //            "<p>\"(word)\" - words in round brackets should be replaced</p>",
  //            List.of("word"),
  //            "<p>\"(<noindex>word</noindex>)\" - words in round brackets should be
  // replaced</p>"),
  //        Arguments.of(
  ...
  //            List.of("word"),
  //            "<p><noindex>word</noindex>, other <noindex>word</noindex> - both words should be
  // replaced</p>"),
  //        Arguments.of(
  //            "<p>word; other word - both words should be replaced</p>",
  //            List.of("word"),
