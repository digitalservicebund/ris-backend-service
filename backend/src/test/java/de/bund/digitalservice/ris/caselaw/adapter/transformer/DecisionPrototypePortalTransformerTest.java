...
class DecisionPrototypePortalTransformerTest {
  ...
  private static DecisionPrototypePortalTransformer subject;
  ...
  static void setUpBeforeClass() {
    ...
    subject = new DecisionPrototypePortalTransformer(documentBuilderFactory);
