...
public class AppealNzbPlaintiffDTO {
  ...
  public void setPrimaryKey(UUID appealId, UUID appealStatusId) {
    primaryKey = new AppealNzbPlaintiffId(appealId, appealStatusId);
  }
}
...
@NoArgsConstructor
@EqualsAndHashCode
class AppealNzbPlaintiffId implements Serializable {
  private UUID appealId;

  private UUID appealStatusId;

  public AppealNzbPlaintiffId(UUID appealId, UUID appealStatusId) {
