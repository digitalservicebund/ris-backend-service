...
@Entity
@Table(schema = "incremental_migration", name = "appeal_joint_revision_plaintiff")
public class AppealJointRevisionPlaintiffDTO {

  @EmbeddedId @Builder.Default
  private AppealJointRevisionPlaintiffId primaryKey = new AppealJointRevisionPlaintiffId();
  ...
  public void setPrimaryKey(UUID appealId, UUID appealStatusId) {
    primaryKey = new AppealJointRevisionPlaintiffId(appealId, appealStatusId);
  }
}
...
@NoArgsConstructor
@EqualsAndHashCode
class AppealJointRevisionPlaintiffId implements Serializable {
