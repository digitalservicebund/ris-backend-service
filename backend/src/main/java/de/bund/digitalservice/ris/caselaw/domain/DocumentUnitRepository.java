...
public interface DocumentUnitRepository {
  ...
  Mono<Long> countGetAllDocumentUnitListEntries(
  ...
  Flux<DocumentUnitListEntry> getAllDocumentUnitListEntries(
      Pageable pageable, DocumentationOffice documentationOfficeId);
