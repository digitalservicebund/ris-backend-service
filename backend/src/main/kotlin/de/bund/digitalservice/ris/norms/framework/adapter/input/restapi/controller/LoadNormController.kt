        ...
        companion object {
            fun fromUseCaseData(data: Norm): NormResponseSchema {
                ...
                return NormResponseSchema(
                    ...
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.ANNOUNCEMENT_GAZETTE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.YEAR, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.NUMBER, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.PAGE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.ADDITIONAL_INFO, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.PRINT_ANNOUNCEMENT, MetadatumType.EXPLANATION, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.ANNOUNCEMENT_MEDIUM, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.DATE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { encodeLocalDate(it.value as LocalDate) },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.EDITION, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.YEAR, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.AREA_OF_PUBLICATION, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.NUMBER_OF_THE_PUBLICATION_IN_THE_RESPECTIVE_AREA, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.ADDITIONAL_INFO, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.DIGITAL_ANNOUNCEMENT, MetadatumType.EXPLANATION, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.EU_GOVERNMENT_GAZETTE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.YEAR, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.SERIES, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.NUMBER, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.PAGE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.ADDITIONAL_INFO, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.EU_ANNOUNCEMENT, MetadatumType.EXPLANATION, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
                    data.getFirstMetadatum(MetadataSectionName.OTHER_OFFICIAL_ANNOUNCEMENT, MetadatumType.OTHER_OFFICIAL_REFERENCE, MetadataSectionName.OFFICIAL_REFERENCE)?.let { it.value as String },
