        ...
        WHERE (
                ...
                OR (
                    n.guid NOT IN (SELECT ms5.norm_guid
                                 ...
                                 JOIN metadata m9 ON ms5.guid = m9.section_guid
                    ...
                    AND (ms3.name = 'DIGITAL_ANNOUNCEMENT' AND ((m5.type = 'EDITION' AND m5.value = :page)
                                                                OR (m5.type = 'PAGE' AND m5.value = :page
                                                                    AND n.guid NOT IN (SELECT ms4.norm_guid
                                                                                     FROM metadata_sections ms4
                                                                                     JOIN metadata m7 ON ms4.guid = m7.section_guid
            ...
            AND (
                ...
                OR (n.announcement_date IS NULL AND m1.type = 'YEAR' AND m1.value = :year AND n.guid NOT IN (SELECT DISTINCT ms6.norm_guid
                                                                                                           FROM metadata_sections ms6
                                                                                                           JOIN metadata m10 ON ms6.guid = m10.section_guid
