...
val hasValidSectionElementsDepth =
    object : Specification<Norm> {
      override fun evaluate(instance: Norm) = SpecificationResult.Satisfied
    }
...
//             "the norm contains a depth in section elements bigger than the maximum depth allowed
// of '${MAX_ALLOWED_DEPTH}") {
//               !maxDepthReached
//             }
//       }
//     }
