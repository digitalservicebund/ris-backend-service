...
E2E_TEST_USER_EXTERNAL=$(gopass show -o -y neuris/maven.pkg.github.com/digitalservicebund/kkern_extern/username)
E2E_TEST_PASSWORD_EXTERNAL=$(gopass show -o -y neuris/maven.pkg.github.com/digitalservicebund/kkern_extern/password)
MY_UID=$(id -u)
MY_GID=$(id -g)
