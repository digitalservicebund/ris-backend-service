...
describe("Principle Entry into force Summarizer", () => {
  test("summarizes the principle entry into force Date", () => {
  ...
  test("summarizes the principle entry into force Undefined date", () => {
    const data: [Metadata, string][] = [
      [
        {
