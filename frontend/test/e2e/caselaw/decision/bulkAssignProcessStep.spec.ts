...
test.describe(
  ...
  () => {
    ...
    test("Dokumentationseinheiten können keinem Prozessschritt zugewiesen werden, solange sie noch Status Fremdanlage haben", async ({
      page,
      pageWithBghUser,
      edition,
    }) => {
      ...
      await test.step("Selektiere Fremdanlage", async () => {
    ...
    test("Dokumentationseinheiten anderer Dokstellen können keinem Prozessschritt zugewiesen werden", async ({
      pageWithBghUser,
    }) => {
