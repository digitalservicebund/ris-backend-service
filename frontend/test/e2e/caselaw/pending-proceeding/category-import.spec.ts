...
test.describe("category import of pending proceeding", () => {
  ...
  test(
    "Rubrikenimport eines Anhängigen Verfahrens in ein Anhängiges Verfahren",
    { tag: ["@RISDEV-7012"] },
    async ({ page, prefilledPendingProceeding, pendingProceeding }) => {
      await navigateToCategoryImport(page, pendingProceeding.documentNumber, {
        type: "pending-proceeding",
      })
  ...
  test(
    "Importiere Schlagwörter von einem Anhängigen Verfahren in ein anhängiges Verfahren",
    { tag: ["@RISDEV-7012"] },
    async ({ page, pendingProceeding, prefilledPendingProceeding }) => {
      await navigateToCategoryImport(page, pendingProceeding.documentNumber, {
        type: "pending-proceeding",
      })
      const keywordsContainer = page.getByTestId("keywords")
  ...
  test(
    "Importiere Sachgebiete von einem Anhängigen Verfahren in ein Anhängiges Verfahren",
    { tag: ["@RISDEV-7012"] },
    async ({ page, pendingProceeding, prefilledPendingProceeding }) => {
      await navigateToCategoryImport(page, pendingProceeding.documentNumber, {
        type: "pending-proceeding",
  ...
  test(
    "Importiere Normen von einem Anhängigen Verfahren in ein Anhängiges Verfahren",
    { tag: ["@RISDEV-7012"] },
    async ({ page, pendingProceeding, prefilledPendingProceeding }) => {
      await navigateToCategoryImport(page, pendingProceeding.documentNumber, {
        type: "pending-proceeding",
