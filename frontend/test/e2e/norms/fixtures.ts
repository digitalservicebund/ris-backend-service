...
export function getNormBySections(norm: NormData): MetadataInputSection[] {
  return [
    ...
    //       values: norm.metadataSections?.DIVERGENT_EXPIRATION?.filter(
    //         (section) => section.DIVERGENT_EXPIRATION_DEFINED
    //       )
    //         .map((section) => section?.DIVERGENT_EXPIRATION_DEFINED?.[0])
    //         .map((section) => section?.DATE?.[0]),
    //     },
    //     {
    //       type: FieldType.CHECKBOX,
    ...
    //     {
    //       type: FieldType.CHECKBOX,
    //       id: MetadataSectionName.DIVERGENT_EXPIRATION_UNDEFINED + NormCategory.AMENDMENT_NORM,
    //       label: "Änderungsnorm",
    //       values: norm.metadataSections?.DIVERGENT_EXPIRATION?.filter(
    //           (section) => section.DIVERGENT_EXPIRATION_UNDEFINED).map(
    //         (section) => section?.DIVERGENT_EXPIRATION_UNDEFINED?.[0]
    //       ).map(
    //         (section) =>
    //           !!section?.NORM_CATEGORY?.find(
    ...
    //     {
    //       type: FieldType.CHECKBOX,
    //       id: MetadataSectionName.DIVERGENT_EXPIRATION_UNDEFINED + NormCategory.BASE_NORM,
    //       label: "Stammnorm",
    //       values: norm.metadataSections?.DIVERGENT_EXPIRATION?.filter(
    //           (section) => section.DIVERGENT_EXPIRATION_UNDEFINED).map(
    //         (section) => section?.DIVERGENT_EXPIRATION_UNDEFINED?.[0]
    ...
    //     {
    //       type: FieldType.CHECKBOX,
    //       id: MetadataSectionName.DIVERGENT_EXPIRATION_UNDEFINED + NormCategory.TRANSITIONAL_NORM,
    //       label: "Übergangsnorm",
    //       values: norm.metadataSections?.DIVERGENT_EXPIRATION?.filter(
    //           (section) => section.DIVERGENT_EXPIRATION_UNDEFINED).map(
    //         (section) => section?.DIVERGENT_EXPIRATION_UNDEFINED?.[0]
