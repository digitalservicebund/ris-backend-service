...
fun convertEditNormRequestSchemaToJson(editNormRequestSchema: EditNormFrameController.NormFramePropertiesRequestSchema): String {
    return Gson().toJson(editNormRequestSchema)
}

fun convertImportormRequestSchemaToJson(importNormRequestSchema: ImportNormController.NormRequestSchema): String {
